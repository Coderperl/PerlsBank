    ...
    function() {
        ...
        function O(e, t, o, n, i) {
            ...
            var p = v(o, n, r, i),
                ...
                d = Object.keys(s).map(function(e) { return fe({ key: e }, s[e], { area: x(s[e]) }) })
        ...
        function _(e, t, o, n) {
            ...
            if ("vh" === p || "vw" === p) {
                ...
                return a = "vh" === p
                    ...
                    : ee(document.documentElement.clientWidth, window.innerWidth || 0), a / 100 * r
            }
            return r
        }
        ...
        function J(e, t) {
            ...
            return o = Y(+n) ? [+n, 0] : X(n, p, s, d), "left" === d
        ...
        var i = te && window.Promise,
            re = i
                ...
                : function(e) {
                    var t = !1;
                    return function() { t || (t = !0, setTimeout(function() { t = !1, e() }, ne)) }
                },
            ...
            ue = function() {
                function t(o, n) {
                    ...
                    de(this, t), this.scheduleUpdate =
                        function() { return requestAnimationFrame(i.update) }, this.update =
                        re(this.update.bind(this)), this.options = fe({}, t.Defaults, r), this.state =
                        ...
                        i.options.modifiers[e] =
                            fe({}, t.Defaults.modifiers[e] || {}, r.modifiers ? r.modifiers[e] : {})
                    }), this.modifiers =
                        Object.keys(this.options.modifiers)
                        .map(function(e) { return fe({ name: e }, i.options.modifiers[e]) })
        ...
        return ue.Utils = ("undefined" == typeof window ? global : window).PopperUtils, ue.placements =
            he, ue.Defaults = {
            placement: "bottom",
            positionFixed: !1,
            eventsEnabled: !0,
                            ...
                            m = {
                                ...
                                secondary: function(e) {
                                    ...
                                    return f[e] > a[e] &&
                                        ...
                                        (n = Q(f[o], a[e] - ("right" === e ? f.width : f.height))), le({}, o, n)
                                }
                            };
                        ...
                        return p.forEach(function(s, d) {
                            ...
                            var a = e.offsets.popper,
                                ...
                                (w && "start" === r && h ||
                                    ...
                                    !w && "end" === r && u);
                            (m || b || y) &&
                            (e.flipped = !0, (m || b) && (n = p[d + 1]), y && (r = z(r)), e.placement =
                                n + (r ? "-" + r : ""), e.offsets.popper =
                                fe({}, e.offsets.popper, D(e.instance.popper, e.offsets.reference, e.placement)), e =
